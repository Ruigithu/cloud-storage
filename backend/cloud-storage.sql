...
-- Started on 2025-02-26 10:44:25
...
--
-- TOC entry 964 (class 1247 OID 16931)
...
--
-- TOC entry 310 (class 1255 OID 16996)
...
CREATE TABLE public.file_permissions (
    ...
    CONSTRAINT file_permissions_check CHECK (((file_id IS NOT NULL) OR (folder_id IS NOT NULL)))
);
...
-- Name: file_permissions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.file_permissions_id_seq OWNER TO postgres;

--
-- TOC entry 5043 (class 0 OID 0)
-- Dependencies: 226
-- Name: file_permissions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- TOC entry 230 (class 1259 OID 17021)
...
CREATE TABLE public.shares (
    ...
    access_type public.permission_type NOT NULL
);
...
--
-- TOC entry 4835 (class 2604 OID 16974)
...
--
-- TOC entry 4833 (class 2604 OID 16941)
...
--
-- TOC entry 4831 (class 2604 OID 16912)
...
--
-- TOC entry 4827 (class 2604 OID 16892)
...
--
-- TOC entry 4823 (class 2604 OID 16870)
...
--
-- TOC entry 4820 (class 2604 OID 16665)
...
--
-- TOC entry 4868 (class 2606 OID 16979)
...
--
-- TOC entry 4859 (class 2606 OID 16947)
...
--
-- TOC entry 4861 (class 2606 OID 16945)
...
--
-- TOC entry 4855 (class 2606 OID 16919)
...
--
-- TOC entry 4851 (class 2606 OID 16897)
...
--
-- TOC entry 4874 (class 2606 OID 17029)
...
-- Name: file_permissions unique_file_folder_user; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.file_permissions
    ADD CONSTRAINT unique_file_folder_user UNIQUE (file_id, folder_id, user_id);


--
-- TOC entry 4842 (class 2606 OID 16673)
...
--
-- TOC entry 4844 (class 2606 OID 16671)
...
--
-- TOC entry 4869 (class 1259 OID 16995)
...
--
-- TOC entry 4870 (class 1259 OID 16994)
...
--
-- TOC entry 4862 (class 1259 OID 16991)
...
--
-- TOC entry 4863 (class 1259 OID 16992)
...
--
-- TOC entry 4864 (class 1259 OID 16993)
...
--
-- TOC entry 4852 (class 1259 OID 16989)
...
--
-- TOC entry 4853 (class 1259 OID 16990)
...
--
-- TOC entry 4847 (class 1259 OID 16986)
...
--
-- TOC entry 4848 (class 1259 OID 16985)
...
--
-- TOC entry 4849 (class 1259 OID 16987)
...
--
-- TOC entry 4871 (class 1259 OID 17041)
-- Name: idx_shares_created_by; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- TOC entry 4872 (class 1259 OID 17040)
-- Name: idx_shares_file_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- TOC entry 4890 (class 2620 OID 16997)
...
--
-- TOC entry 4889 (class 2620 OID 16998)
...
--
-- TOC entry 4888 (class 2620 OID 16999)
...
--
-- TOC entry 4885 (class 2606 OID 16980)
...
--
-- TOC entry 4881 (class 2606 OID 16965)
...
--
-- TOC entry 4882 (class 2606 OID 16950)
...
--
-- TOC entry 4883 (class 2606 OID 16955)
...
--
-- TOC entry 4884 (class 2606 OID 16960)
...
--
-- TOC entry 4879 (class 2606 OID 16925)
...
--
-- TOC entry 4880 (class 2606 OID 16920)
...
--
-- TOC entry 4877 (class 2606 OID 16898)
...
--
-- TOC entry 4878 (class 2606 OID 16903)
...
--
-- TOC entry 4875 (class 2606 OID 16883)
...
--
-- TOC entry 4876 (class 2606 OID 16878)
...
--
-- TOC entry 4887 (class 2606 OID 17030)
-- Name: shares shares_file_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.shares
    ADD CONSTRAINT shares_file_id_fkey FOREIGN KEY (file_id) REFERENCES public.files(id);


-- Completed on 2025-02-26 10:44:25
